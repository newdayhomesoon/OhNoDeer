...
export declare const transactionSk2ToPurchaseMap: ({ id, originalPurchaseDate, productID, purchaseDate, purchasedQuantity, originalID, verificationResult, appAccountToken, appTransactionID, jsonRepresentation, }: TransactionSk2) => Purchase;
/**
